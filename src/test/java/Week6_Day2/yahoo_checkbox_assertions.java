...
public class yahoo_checkbox_assertions extends ReUsable_annotation_class {
    ...
    public void checkboxAssertion() throws IOException, InterruptedException {
        ...
        Thread.sleep(2000);
        //verify the checkbox stay signed in is selected using testNg assertion using testNG soft assertion
